//Assignment86WAP on StringBuffer using append, insert, delete, substring, reverse, Capacity, replace
package string01;

public class StringBufferFunctions {

	public static void main(String[] args) {
		String s2  = new String("Java Program @2025");
		System.out.println(s2.concat("...Hello World!"));
		System.out.println(s2); // String is immutable in nature, original value did not change after concat
		
		StringBuffer s1 = new StringBuffer("Java Program @2025");
